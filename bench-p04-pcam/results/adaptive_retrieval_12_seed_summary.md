...
| 13 | 0.869 | 0.895 | +0.025 | 12.11 | 12.11 | 1.00x |
...
- Spread `<= 1.0x` seeds: `2`
- Retrieval points: `55.07`
- Anisotropy points: `0.06`
- Total automated: `55.13 / 90.0`


## Decision

Aggressive adaptive retrieval improves 12-seed retrieval versus stable (`+0.039` mean delta, `+0.011` min delta), but fails the spread gate with `2` seeds at spread `<= 1.0x`. Do not run 20-seed and do not adopt.
