...
Output after aligning the default clean-distance threshold to `0.20`:

```text
ANVIL · P-04 · PCAM Precision Agent — Self-Check
==============================================================
  total wall time            194174.8 ms
  seeds                             5
  ...
  ----------------------------------------------------------
   ...
   404     0.717    0.800  +0.083   12.40   12.31   1.01×
  ...
  anisotropy    (max 20)              0.13
  code quality  (max 10)            (manual)
  TOTAL AUTOMATED                    70.13  / 90
