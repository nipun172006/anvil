"""Top-k retrieval precision blended with Hessian-aware geometry."""
...
class _TopKHessianBase:
    GeometryClass = HessianDiagonalGeometryAgent
    ...
    def __init__(
        ...
        self.geometry = self.GeometryClass(self.X, self.model_params)
...
class TopKHessianDiagonalPrecisionAgent(_TopKHessianBase):
    """Blend top-k consensus with Hessian diagonal geometry."""

    GeometryClass = HessianDiagonalGeometryAgent


class TopKHessianRuizPrecisionAgent(_TopKHessianBase):
    """Blend top-k consensus with Hessian Ruiz equilibration."""

    GeometryClass = HessianRuizGeometryAgent
